...
## Features
- Subclasses the standard `SO101Follower` robot to add force sensing at the gripper.
...
Then, use the lerobot python or command-line scripts like you would with the default SO-100/SO-101. **Be sure to include sensor_port argument for the robot.**
